"""
screen_help_calibration.py
---
This file contains the CalibrationHelpScreen class, which is the Help Screen regarding Goal Calibration in Ball-E's GUI.
---
...
class CalibrationHelpScreen(QWidget):
    """CalibrationHelpScreen.

    This class instantiates and sets up the QWidget object with all appropriate Questions and Answers regarding Goal Calibration
    """
